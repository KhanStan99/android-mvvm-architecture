...
import `in`.trentweet.reminderlist.databinding.ActivityLoginBinding
...
import `in`.trentweet.reminderlist.util.snackbar
...
class LoginAct : AppCompatActivity(), AuthListener, KodeinAware {
